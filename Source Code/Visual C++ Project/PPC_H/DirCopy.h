...
typedef	F_PASCAL_PTR(Boolean,*CopyErrProcPtr) (OSErr error,
...
typedef	F_PASCAL_PTR(Boolean,*CopyFilterProcPtr) (const CInfoPBRec * const cpbPtr);
...
F_PASCAL(OSErr)	FilteredDirectoryCopy(short srcVRefNum,
									  long srcDirID,
									  StringPtr srcName,
									  short dstVRefNum,
									  long dstDirID,
...
F_PASCAL(OSErr)	FSpFilteredDirectoryCopy(const FSSpec *srcSpec,
...
F_PASCAL(OSErr)	DirectoryCopy(short srcVRefNum,
							  long srcDirID,
							  StringPtr srcName,
							  short dstVRefNum,
							  long dstDirID,
...
F_PASCAL(OSErr)	FSpDirectoryCopy(const FSSpec *srcSpec,
								 const FSSpec *dstSpec,
								 void *copyBufferPtr,
								 long copyBufferSize,
								 Boolean preflight,
